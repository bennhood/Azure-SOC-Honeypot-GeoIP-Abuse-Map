...
Screenshot: Querying the forwarded logs from our VM, and searching for "4625" : Failed log on events - approximately 13,000 events since opening up the VM to the net, highlighting the importance of proper defence and security controls; automated reconnaissance is persistent, especially on the open net. Security Controls require proper configuration to avoid leakage.
