...
_Overview of project scope and network map._
...
_NSG being opened/disabled to allow all outside traffic - opening the honeypot._
...
_Querying the forwarded logs from our VM, and searching for "4625 : Failed log on events - approximatly 13,000 events since opening up the VM to the net, highlighting the importance of proper defence and security controls._
...
_Creating the GeoIP watchlist for data enrichment towards geomapping the abuse using a custom CSV of geo data._
...
_Querying the newly enriched data using KQL - IpAddresses are now associated with a geographical location._
...
_Isolating KQL searching to one IP result revealing 2,500 from this one IP - The volume, frequency, and uniformity of failed authentication attempts strongly indicate automated brute-force activity rather than manual interaction._
...
_Creating the visual geomap of abuse IP locations, using JSON._
...
_The workbook presented, showing a global network of various attacking locations._
...
_Further KQL searching into brute force possibility confirms a match, with thousands of attempts originating from multiple different IP addresses._
